                    ...
                    <asp:GridView ID="gv_User_Mgt" runat="server" AutoGenerateColumns="false" DataKeyNames="UserId" BorderStyle="None" BorderWidth="1px" CellPadding="3"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnEdit" runat="server" ImageUrl="~/assets/img/edit.jpg" Style="width: 50%; height: 7%" ToolTip="Edit"
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">Edit User Details:
                                            <asp:Label runat="server" ID="lbl_BSMUser" style="color:#6bca4a" ></asp:Label></h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="dll_Status_up" runat="server"   CssClass="form-control">
                                                         ...
                                                         <asp:ListItem Value="UnAuthorised">UnAuthorised</asp:ListItem>
                                    ...
                                    <div class="modal-footer">
                                        <div class="text-center">
                                            <input type="button" class="btn btn-success center"  value="Update" onclick="Update_Details()">
                                    <%--    <asp:LinkButton ID="lnk_edit" runat="server" Text="Update"  CssClass="btn btn-success center" ></asp:LinkButton>--%>

                                        <button type="button" class="btn btn-success center" data-dismiss="modal">Cancel</button>
                                            </div>
                                    </div>
...
<script type = "text/javascript">
    function Update_Details() {
        ...
        var dll_Pricing_Plan_up = $("#dll_Pricing_Plan_up :selected").val();
        var dll_Status_up = $("#dll_Status_up :selected").val();
